  ...
  const RENDERS = {
    "Sunlit Linen": [
      ["assets/renders/yellow-linen-main-v2.jpg",  "Angled view"],
      ["assets/renders/yellow-linen-angle-v2.jpg", "Rear three-quarter"],
      ["assets/renders/yellow-linen-top.jpg",   "Top view"],
      ["assets/renders/yellow-linen-seat-v2.jpg",  "Seat & power outlet"],
      ["assets/renders/yellow-linen-niche.jpg", "Lit shelf niche"]
    ],
    "Marine Twill": [
      ["assets/renders/blue-twill-main-v2.jpg",   "Angled view"],
    ...
    "Forest Velvet": [
      ["assets/renders/green-velvet-main-v2.jpg",   "Angled view"],
    ...
    "Mulberry Linen": [
      ["assets/renders/violet-linen-main-v2.jpg",   "Angled view"],
